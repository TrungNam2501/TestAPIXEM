...
{
    public class Get_Excel_InlaiBB
    {
        public static string Create_Excel(string partno, string effdat, string pathFile, string loaikeo, string slipno, string barcode, string ca, string daylimt, string Soluong, string mesid, string Machno, string pday, string indat, string classs, string intime, string pallet, string description, string someSx)
        {
            try
            {
                ...
                using (ExcelPackage package = new ExcelPackage(newFile))
                {
                    ...
                    worksheet.Cells["D15"].Value = partno;
